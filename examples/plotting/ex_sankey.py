...
tp.sankey(source=2, target=7, source_groups={"cell_type": ["HSC", "MasP", "MkP"]}, target_groups={"cell_type": ["HSC", "MasP", "MkP"]}, forward=True, return_data=False, key_added=new_key)
